...
class BedIntervalTree:
    ...
    def countbases(
        ...
        if not chrom and label:
            ...
            return sum([self.nt_count_by_label[x] for x in self.nt_count_by_label])
    ...
    def _process_bed_file(
        self, bed_file, label: Union[str, Callable], fixchr: bool
    ) -> None:
