...
- If integration tests are failing with "rtg: command not found" errors, ensure the `--engine-vcfeval-path` argument is correctly passed to the `hap.py` call within the test.
