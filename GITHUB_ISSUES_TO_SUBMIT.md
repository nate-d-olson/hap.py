# GitHub Issues to Submit - hap.py Testing Problems

This document contains the complete specifications for GitHub issues that should be submitted to the repository based on the comprehensive test analysis completed.
...
## Issue #1: Integration Tests Hanging/Unresponsive During Execution
...
## Issue #2: GA4GH Integration Tests Failing with Import/Setup Errors
...
## Issue #3: VCF Processing Integration Tests Failing
...
1. Go to: https://github.com/nate-d-olson/hap.py/issues
2. Click "New issue"
3. Copy the title and description for each issue above
4. Add the appropriate labels: bug, testing, integration/ga4gh/vcf-processing
5. Submit each issue individually

## Additional Context

These issues were identified during comprehensive testing of the modernized hap.py codebase. All unit tests are now passing (71 passed, 5 skipped), but integration tests remain problematic due to the issues documented above.

The testing was performed in a micromamba environment with Python 3.11.12 and all required dependencies properly installed. The analysis included both automated test execution and manual debugging to identify root causes.
